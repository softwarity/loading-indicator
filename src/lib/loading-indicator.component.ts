import { Component, computed, input, signal, OnInit, OnDestroy, booleanAttribute, numberAttribute } from '@angular/core';

/**
 * Material 3 Expressive Loading Indicator
 *
 * 20 points (10 pointes alternant outer/inner)
 * Animation entre 7 formes organiques avec morphing fluide
 */
@Component({
